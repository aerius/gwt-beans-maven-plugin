...
/**
 * Exception thrown when the parser generator encounters a type that it does not
 * support.
 * This provides a clear error message to users about which types cannot be
 * handled.
 */
public class UnsupportedTypeException extends RuntimeException {
  ...
  /**
   * Creates a new UnsupportedTypeException with a message about the unsupported
   * type.
   * 
   * @param typeName        The name of the unsupported type
   * @param fieldName       The name of the field containing the unsupported type
   * @param containingClass The class containing the field with the unsupported
   *                        type
   */
