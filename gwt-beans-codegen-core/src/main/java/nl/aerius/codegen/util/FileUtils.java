...
/**
 * Utility class for file system operations, providing centralized file and path
 * management functionality across the codebase.
 */
public final class FileUtils {
  ...
  /**
   * Discovers all subclasses of a given class that are available on the
   * classpath.
   *
  ...
  /**
   * Analyzes a field's type and processes any discovered types using the provided
   * consumer.
   * This is used by both TypeAnalyzer and ConfigurationValidator to discover and
   * process types.
   *
   * @param field         The field to analyze
   * @param typeProcessor Consumer that will process each discovered type
   * @throws TypeNotPresentException if a type is referenced but not found in the
   *                                 classpath
   */
